...
BuildRequires: gcc cmake make python3-docutils libtar libtar-devel zlib zlib-devel libzstd libzstd-devel
BuildRequires: libev libev-devel openssl openssl-devel systemd systemd-devel
Requires:      libev openssl systemd postgresql libtar zlib libzstd
