...
| :-------- | :---------- |
| version | La cadena de versión semántica del pgmoneta en ejecución (por ejemplo, "0.22.0"). |
...
Reporta el tamaño en bytes de cada base de datos en el servidor PostgreSQL.
