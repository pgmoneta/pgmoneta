...
Descifrando el archivo en su lugar, elimina el archivo cifrado después de la decriptación exitosa.
...
Cifrando el archivo en su lugar, elimina el archivo sin cifrar después del cifrado exitoso.
...
Verifica si tu CPU tiene [AES-NI][aes_ni]
...
Por defecto, openssl utiliza AES-NI si la CPU lo tiene.
...
*: AES-NI deshabilitado; 8: 8 núcleos; d: decriptación
