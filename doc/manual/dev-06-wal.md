...
Usage:
  pgmoneta-walinfo [-c CONFIG_FILE] [-u USERS_FILE] <file>
...
Options:
  ...
  -m, --mapping		    Set the path to the json file that contains the mapping of the OIDs to the corresponding object names
  -?, --help           	    Display help
```
