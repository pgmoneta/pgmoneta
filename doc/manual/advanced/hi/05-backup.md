...
## पूर्ण बैकअप बनाएं (Create a Full Backup)  

हम निम्नलिखित कमांड का उपयोग करके प्राइमरी से पूर्ण बैकअप ले सकते हैं:
...
## वृद्धिशील बैकअप बनाएं (Create an Incremental Backup)  

हम निम्नलिखित कमांड का उपयोग करके प्राइमरी से वृद्धिशील (incremental) बैकअप ले सकते हैं:  

```
pgmoneta-cli backup primary 20240928065644
```

और आपको निम्नलिखित आउटपुट मिलेगा:  
...
**वृद्धिशील बैकअप केवल [PostgreSQL 17+](https://www.postgresql.org) में समर्थित हैं।**  
ध्यान दें कि वर्तमान में वृद्धिशील बैकअप के लिए शाखाएं (branching) अनुमति नहीं दी गई हैं — एक बैकअप में अधिकतम 1 वृद्धिशील बैकअप चाइल्ड हो सकता है।  

---

## बैकअप देखें (View Backups)  

हम किसी सर्वर के लिए सभी बैकअप को सूचीबद्ध करने के लिए निम्नलिखित कमांड का उपयोग कर सकते हैं:  
