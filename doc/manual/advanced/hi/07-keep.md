...
ध्यान दें कि `Keep` वर्तमान में केवल पूर्ण (full) बैकअप पर कार्य करता है। हम भविष्य के संस्करणों में वृद्धिशील (incremental) बैकअप को बनाए रखने का समर्थन करेंगे।
